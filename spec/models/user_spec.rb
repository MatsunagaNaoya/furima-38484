  ...
  describe 'ユーザー新規登録' do
    ...
    context '新規登録できないとき' do
      ...
      it 'last_nameが半角カナでは登録できない' do
        @user.last_name = 'ｻｸﾗ'
        @user.valid?
        expect(@user.errors.full_messages).to include('苗字は日本語で入力してください')
      end
      it 'first_nameが半角カナでは登録できない' do
        @user.first_name = 'ﾅﾙﾄ'
        @user.valid?
        expect(@user.errors.full_messages).to include('名前は日本語で入力してください')
      end
      ...
      it 'last_name_kanaが半角カナでは登録できない' do
        ...
        @user.valid?
        expect(@user.errors.full_messages).to include('苗字カナはカタカナで入力してください')
      end
      it 'first_name_kanaが半角カナでは登録できない' do
        @user.first_name_kana = 'ｶｶｼ'
        @user.valid?
        expect(@user.errors.full_messages).to include('名前カナはカタカナで入力してください')
      end
